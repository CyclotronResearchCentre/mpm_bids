...
"""
path_bids  = "/Users/voelzkey/Desktop/Data/QSMData/ISMRM2023"  # folder where you want to build your BIDS structure
path_dcm   = "/Users/voelzkey/Desktop/Data/QSMData/scans"      # folder with the dicom scans (download from xnat and extract)

site = "DZNE"    # site in BIDS (keep DZNE)
subj = "subj-04" # name of the subject... there is a check if subject already exists
